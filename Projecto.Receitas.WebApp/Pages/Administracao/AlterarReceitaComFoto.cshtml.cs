...
{
    public class AlterarReceitaComFotoModel : PageModel
    {
        ...
        public AlterarReceitaComFotoModel(IReceitaService receitaService, ICategoriaService categoriaService, IUtilizadorService utilizadorService)
        {
        ...
        [BindProperty]
        public ReceitaViewModelId Receita { get; set; }
        ...
        public IActionResult OnGet(int idReceita, int idPagina = 0, string? texto = "")
        {
            ...
            Receita = new ReceitaViewModelId()
            {
