...
{
    public class FinalizarAlterarReceitaSemImagemModel : PageModel
    {
        ...
        public FinalizarAlterarReceitaSemImagemModel(IReceitaService receitaService, ICategoriaService categoriaService
        ...
        [BindProperty]
        public ReceitaViewModelSemEstadoSemImagemId Receita { get; set; }
        ...
        public IActionResult OnGet(int id,string codigo)
        {
            ...
            Receita = new ReceitaViewModelSemEstadoSemImagemId()
            {
