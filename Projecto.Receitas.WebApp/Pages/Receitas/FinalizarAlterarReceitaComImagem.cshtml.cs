...
{
    public class FinalizarAlterarReceitaComImagemModel : PageModel
    {
        ...
        public FinalizarAlterarReceitaComImagemModel(IReceitaService receitaService, ICategoriaService categoriaService
        ...
        [BindProperty]
        public ReceitaViewModelSemEstadoId Receita { get; set; }
        ...
        public IActionResult OnGet(int id,string codigo)
        {
            ...
            Receita = new ReceitaViewModelSemEstadoId()
            {
        ...
        public IActionResult OnPost()
        {
            if (ModelState.IsValid)
            {
                ...
                Receita receita = new Receita(Receita.ReceitaId, Receita.Titulo, Receita.ImagemUrl, Receita.ModoDePreparacao,
                    (Tempo)Receita.TempoDePreparacao, TipoDeEstado.Pendente, (GrauDeDificuldade)Receita.Dificuldade,
                ...
                return RedirectToPage("/Receitas/FinalizarAdicionarReceita", new { id = Receita.ReceitaId , codigo = Codigo });
            }
